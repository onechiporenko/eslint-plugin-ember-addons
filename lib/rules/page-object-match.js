...
module.exports = {
  ...
  create: function (context) {
    ...
    const ignoredComponents = opts.hasOwnProperty("ignoredComponents") ? opts.ignoredComponents.map(pageObject.addExtension) : [];
    const ignoredPages = opts.hasOwnProperty("ignoredPages") ? opts.ignoredPages.map(pageObject.addExtension) : [];
